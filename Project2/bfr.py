...
# Only exercise 1.1 is fully functional for the 3 first exercises, some functions that would support the bfr algorithm for 1.2 were made

# To run the program to find optimal k and statistics for each k: spark-submit bfr.py -o results
